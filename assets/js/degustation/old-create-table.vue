    ...
    <div class='blc_table_new_deg' >
        ...
        <table class="table table-all" >
            ...
            <tr v-for="(product,index) in degustation.products" >
                ...
                <td class='icon_wrapper align-middle' @click="wantDeleteProduct" >
        ...
        <b-row >
            ...
            <b-col sm="6" >
                <b-form-row class="mb-3" v-show="Boolean(degustation.link)">

                        <label >Ссылка которая понадобитсья на дегустации:</label >
                        <b-input-group class="mb-3"  >

                            <b-form-input id='copy' v-model="degustation.link" ></b-form-input >
                            <b-input-group-append >
                                <b-button variant="outline-success" v-show="!copied" @click="copyLink" >Скопировать
                                </b-button >
                                <b-button variant="success" v-show="copied" @click="copyLink" >Ссылка скопирована!
                                </b-button >
                            </b-input-group-append >
                        </b-input-group >
        ...
        methods: {
            ...
            createDegustation: function () {
                ...
                axios.post('/ajax/' + this.project_id + '/degustation/create',
                    ...
                    this.degustation.link = response.data.degustation.link
            ...
            wantDeleteProduct: function(index){
                this.index_delet = index,
                    this.modalShow = true
            },
